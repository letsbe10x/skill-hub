...
triggers:
  ...
  - forge a skill
discovery_signals:
  keywords: [skill, authoring, scaffold, enhance, forge, bundle, benchmark, eval]
...
Bundle folder, generate starter datasets, run benchmarks, analyze results, and accept
only reviewed quality summaries.
...
1. Decide whether you are creating, enhancing, or evaluating an existing skill.
...
3. Initialize or validate the Skill Bundle.
...
4. Generate starter datasets, then curate them before treating them as evidence.
...
5. Validate the result and iterate until the gates pass.
...
6. Run the eval loop when the skill needs measured quality evidence.
...
7. If the skill is ready to ship:
